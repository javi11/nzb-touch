...
require (
	...
	github.com/javi11/nntpcli v0.5.0 // indirect
	...
	github.com/mnightingale/rapidyenc v0.0.0-20240809192858-2494683cdd67 // indirect
...
// Dependencies will be fetched when running "go mod tidy"
